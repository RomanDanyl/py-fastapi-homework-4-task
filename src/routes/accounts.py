...
async def register_user(
    ...
    try:
        ...
        activation_link = f"http://127.0.0.1:8000/accounts/activate/{activation_token.token}/"
...
async def activate_account(
    ...
    activation_link = f"http://127.0.0.1:8000/accounts/login/{token_record.token}/"
    background_tasks.add_task(
...
async def request_password_reset_token(
    ...
    activation_link = f"http://127.0.0.1:8000/accounts/password-reset/complete/{reset_token.token}"
    background_tasks.add_task(
